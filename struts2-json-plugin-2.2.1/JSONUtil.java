...
public class JSONUtil {
    ...
    public static String serialize(Object object, Collection<Pattern> excludeProperties,
            ...
            throws JSONException {
        JSONWriter writer = new JSONWriter();		//构建JSONWriter类
        writer.setIgnoreHierarchy(ignoreHierarchy);
        return writer.write(object, excludeProperties, includeProperties, excludeNullProperties);//调用JSONWriter中的write来具体实现
    }
